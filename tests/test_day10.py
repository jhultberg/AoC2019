import pytest
from aoc.day10 import is_colinear, find_angle_from_vertical, find_stars, find_asteroids, is_between_points, destroy_asteroids, solve, find_most_asteroids
...
def test_find_angle_from_vertical():
    assert round(find_angle_from_vertical((0,0), (0,1))) == 0
    assert find_angle_from_vertical((0,0), (0,1)) < find_angle_from_vertical((0,0), (1,0))
...
def test_find_asteroids():
    assert find_asteroids(stars, (3, 4)) == {(4, 4), (1, 2), (4, 0), (4, 3), (4, 2), (0, 2), (2, 2), (3, 2)}
...
def _test_solve():
   assert solve('data/day10.txt') == (267, None)
